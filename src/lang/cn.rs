...
// Modification: 将中文语言资源中的品牌名 "RustDesk" 重命名为 "远程协助"
...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [远程协助] 服务开启。"),
